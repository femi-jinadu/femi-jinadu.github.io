...
* **1) Unified Self-Supervised Algorithm for Speech, Vision, and Text: Meta’s data2vec Project** [Term paper re-write here](files/Final_Paper(2).pdf) [original author paper](https://ai.meta.com/research/data2vec-a-general-framework-for-self-supervised-learning-in-speech-vision-and-language/)
* **2) Classifying Review Sentiment with Bag-of-Words Features** [project documentation](files/cs135_project02.pdf)
